...
export function SimpleContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Using Web3Forms - a simple form submission service
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "YOUR_ACCESS_KEY_HERE", // This will be replaced
          ...
          to_email: "vertrieb@ntconsult.de,jhroth@ntconsult.de"
        }),
      })
      ...
      setErrorMessage("Bitte senden Sie uns eine E-Mail an vertrieb@ntconsult.de")
    } finally {
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <button
                        ...
                        className="text-custom-blue-600 hover:underline text-lg block"
                      >
                        vertrieb@ntconsult.de
                      </button>
                      <button
                        onClick={() => copyToClipboard("jhroth@ntconsult.de", "email")}
                        className="text-custom-blue-600 hover:underline text-lg block"
                      >
                        jhroth@ntconsult.de
                      </button>
