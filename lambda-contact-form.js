...
exports.handler = async (event) => {
  ...
  try {
    ...
    const emailParams = {
      Source: 'jhroth@ntconsult.de', // Using verified email as sender
      Destination: {
        ToAddresses: ['jhroth@ntconsult.de'] // Only sending to verified email for now
      },
      ReplyToAddresses: [email], // Set user's email as reply-to
      Message: {
        Subject: {
                ...
                <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <p style="margin-top: 30px; font-size: 12px; color: #6b7280; text-align: center;">
                      ...
                      Zeitstempel: ${new Date().toLocaleString('de-DE', { timeZone: 'Europe/Berlin' })}<br>
                      <strong>Hinweis:</strong> Diese E-Mail geht temporär nur an jhroth@ntconsult.de.<br>
                      Sobald vertrieb@ntconsult.de verifiziert ist, werden beide Adressen verwendet.
                    </p>
                  </div>
                </body>
              </html>
